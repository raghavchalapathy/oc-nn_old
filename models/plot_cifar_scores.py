...
def plot_decision_scores_CIFAR(dataset,df_cifar_scores):
    ...
    _=axarr[2, 0].hist(df_cifar_scores["One_Class_NN_explicit-Linear-Test"], bins = 25, label = 'Anomaly')
    _=axarr[2, 0].set_title("One_Class_NN_explicit:  " + activations[0]);

    _=axarr[2, 1].hist(df_cifar_scores["One_Class_NN_explicit-Sigmoid-Train"], bins = 25, label = 'Normal')
    _=axarr[2, 1].hist(df_cifar_scores["One_Class_NN_explicit-Sigmoid-Test"], bins = 25, label = 'Anomaly')
